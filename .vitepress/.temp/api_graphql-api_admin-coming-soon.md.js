...
const __pageData = JSON.parse('{"title":"Admin API","description":"","frontmatter":{},"headers":[],"relativePath":"api/graphql-api/admin-coming-soon.md","filePath":"api/graphql-api/admin-coming-soon.md","lastUpdated":1770102569000}');
const _sfc_main = { name: "api/graphql-api/admin-coming-soon.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("api/graphql-api/admin-coming-soon.md");
