...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Bagisto","description":"Bagisto Developer Documentation","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"siteTitle":false,"logo":{"light":"/logo.png","dark":"/logo-dark.png"},"nav":[{"text":"Dev Docs","link":"https://devdocs.bagisto.com/"},{"text":"User Guide","link":"https://docs.bagisto.com/"},{"text":"Extensions","link":"https://bagisto.com/en/extensions/"},{"text":"Community Forum","link":"https://forums.bagisto.com/"},{"text":"Contact Us","link":"https://bagisto.com/en/contacts/"}],"editLink":{"pattern":"https://github.com/bagisto/bagisto-api-docs/edit/master/src/:path","text":"Help us improve this page on Github."},"lastUpdated":{"text":"Last Updated","formatOptions":{"dateStyle":"full"}},"sidebar":[{"text":"Bagisto APIs","collapsed":false,"items":[{"text":"Introduction","link":"/api/introduction"},{"text":"Setup","link":"/api/setup"},{"text":"Authentication","link":"/api/authentication"},{"text":"Storefront Keys","link":"/api/storefront-api-key-management-guide"},{"text":"GraphQL API","collapsed":true,"items":[{"text":"Introduction","link":"/api/graphql-api/introduction"},{"text":"Authentication","link":"/api/graphql-api/authentication"},{"text":"Shop API","collapsed":false,"items":[{"text":"Locales","collapsed":false,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Locales","link":"/api/graphql-api/shop/locales/queries/locales"},{"text":"Single Locale","link":"/api/graphql-api/shop/locales/queries/single-locale"}]}]},{"text":"Category","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Tree Categories","link":"/api/graphql-api/shop/queries/tree-categories"},{"text":"Categories","link":"/api/graphql-api/shop/queries/categories"},{"text":"Single Category","link":"/api/graphql-api/shop/queries/get-category"}]}]},{"text":"Theme Customisations","collapsed":false,"items":[{"text":"Theme Customisations","link":"/api/graphql-api/shop/queries/theme-customisations"},{"text":"Single Theme Customisation","link":"/api/graphql-api/shop/queries/single-theme-customisation"}]},{"text":"CMS Pages","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Pages","link":"/api/graphql-api/shop/queries/get-pages"},{"text":"Single Page","link":"/api/graphql-api/shop/queries/get-page"}]}]},{"text":"Product","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Products","link":"/api/graphql-api/shop/queries/get-products"},{"text":"Search Products","link":"/api/graphql-api/shop/queries/search-products"},{"text":"Single Product","link":"/api/graphql-api/shop/queries/get-product"}]}]},{"text":"Product Review","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Product Reviews","link":"/api/graphql-api/shop/queries/get-product-reviews"}]},{"text":"Mutations","collapsed":false,"items":[{"text":"Create Product Review","link":"/api/graphql-api/shop/mutations/create-product-review"},{"text":"Update Product Review","link":"/api/graphql-api/shop/mutations/update-product-review"},{"text":"Delete Product Review","link":"/api/graphql-api/shop/mutations/delete-product-review"}]}]},{"text":"Attribute","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Attributes","link":"/api/graphql-api/shop/queries/get-attributes"},{"text":"Single Attribute","link":"/api/graphql-api/shop/queries/get-attribute"},{"text":"Attribute Options","link":"/api/graphql-api/shop/queries/get-attribute-options"}]}]},{"text":"Channel","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Channels","link":"/api/graphql-api/shop/queries/get-channels"},{"text":"Single Channel","link":"/api/graphql-api/shop/queries/get-channel"}]}]},{"text":"Country","collapsed":false,"items":[{"text":"Single Country","link":"/api/graphql-api/shop/queries/get-country"},{"text":"Countries","link":"/api/graphql-api/shop/queries/get-countries"},{"text":"Country States","link":"/api/graphql-api/shop/queries/get-country-states"},{"text":"Country State","link":"/api/graphql-api/shop/queries/get-country-state"}]},{"text":"Customer","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Get Customer Profile","link":"/api/graphql-api/shop/queries/get-customer-profile"},{"text":"Get Customer Orders","link":"/api/graphql-api/shop/queries/get-customer-orders"},{"text":"Get Customer Order","link":"/api/graphql-api/shop/queries/get-customer-order"},{"text":"Get Customer Order Shipments","link":"/api/graphql-api/shop/queries/get-customer-order-shipments"},{"text":"Get Customer Order Shipment","link":"/api/graphql-api/shop/queries/get-customer-order-shipment"},{"text":"Get Customer Invoices","link":"/api/graphql-api/shop/queries/get-customer-invoices"},{"text":"Get Customer Invoice","link":"/api/graphql-api/shop/queries/get-customer-invoice"},{"text":"Download Invoice","link":"/api/graphql-api/shop/queries/download-invoice"},{"text":"Get Downloadable Products","link":"/api/graphql-api/shop/queries/get-customer-downloadable-products"},{"text":"Get Downloadable Product","link":"/api/graphql-api/shop/queries/get-customer-downloadable-product"},{"text":"Get Customer Addresses","link":"/api/graphql-api/shop/queries/get-customer-addresses"}]},{"text":"Mutations","collapsed":false,"items":[{"text":"Customer Registration","link":"/api/graphql-api/shop/mutations/customer-registration"},{"text":"Customer Login","link":"/api/graphql-api/shop/mutations/customer-login"},{"text":"Customer Verify Token","link":"/api/graphql-api/shop/mutations/customer-verify-token"},{"text":"Customer Logout","link":"/api/graphql-api/shop/mutations/customer-logout"},{"text":"Update Customer Profile","link":"/api/graphql-api/shop/mutations/update-customer-profile"},{"text":"Delete Customer Profile","link":"/api/graphql-api/shop/mutations/delete-customer-profile"},{"text":"Forgot Password","link":"/api/graphql-api/shop/mutations/forgot-password"},{"text":"Create Customer Address","link":"/api/graphql-api/shop/mutations/create-customer-address"},{"text":"Update Customer Address","link":"/api/graphql-api/shop/mutations/update-customer-address"},{"text":"Delete Customer Address","link":"/api/graphql-api/shop/mutations/delete-customer-address"},{"text":"Cancel Customer Order","link":"/api/graphql-api/shop/mutations/cancel-customer-order"},{"text":"Reorder Customer Order","link":"/api/graphql-api/shop/mutations/reorder-customer-order"},{"text":"Get Customer Reviews","link":"/api/graphql-api/shop/queries/get-customer-reviews"},{"text":"Get Customer Review","link":"/api/graphql-api/shop/queries/get-customer-review"}]}]},{"text":"Cart","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Get Cart","link":"/api/graphql-api/shop/queries/get-cart"}]},{"text":"Mutations","collapsed":false,"items":[{"text":"CreateCart","link":"/api/graphql-api/shop/mutations/create-cart"},{"text":"AddToCart","link":"/api/graphql-api/shop/mutations/add-to-cart"},{"text":"UpdateCartItem","link":"/api/graphql-api/shop/mutations/update-cart-item"},{"text":"RemoveCartItem","link":"/api/graphql-api/shop/mutations/remove-cart-item"},{"text":"ApplyCoupon","link":"/api/graphql-api/shop/mutations/apply-coupon"},{"text":"RemoveCoupon","link":"/api/graphql-api/shop/mutations/remove-coupon"}]}]},{"text":"Checkout","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Get Addresses","link":"/api/graphql-api/shop/queries/get-addresses"},{"text":"Get Shipping Methods","link":"/api/graphql-api/shop/queries/get-shipping-methods"},{"text":"Get Payment Methods","link":"/api/graphql-api/shop/queries/get-payment-methods"}]},{"text":"Mutations","collapsed":false,"items":[{"text":"Set Shipping Address","link":"/api/graphql-api/shop/mutations/set-shipping-address"},{"text":"Set Billing Address","link":"/api/graphql-api/shop/mutations/set-billing-address"},{"text":"Set Shipping Method","link":"/api/graphql-api/shop/mutations/set-shipping-method"},{"text":"Set Payment Method","link":"/api/graphql-api/shop/mutations/set-payment-method"},{"text":"Place Order","link":"/api/graphql-api/shop/mutations/place-order"}]}]},{"text":"Wishlist","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Get Wishlists","link":"/api/graphql-api/shop/queries/get-wishlists"},{"text":"Get Wishlist Item","link":"/api/graphql-api/shop/queries/get-wishlist"}]},{"text":"Mutations","collapsed":false,"items":[{"text":"Create Wishlist","link":"/api/graphql-api/shop/mutations/create-wishlist"},{"text":"Toggle Wishlist","link":"/api/graphql-api/shop/mutations/toggle-wishlist"},{"text":"Delete Wishlist","link":"/api/graphql-api/shop/mutations/delete-wishlist"},{"text":"Move to Cart","link":"/api/graphql-api/shop/mutations/move-wishlist-to-cart"},{"text":"Delete All Wishlists","link":"/api/graphql-api/shop/mutations/delete-all-wishlists"}]}]},{"text":"Compare","collapsed":true,"items":[{"text":"Queries","collapsed":false,"items":[{"text":"Get Compare Items","link":"/api/graphql-api/shop/queries/get-compare-items"},{"text":"Get Compare Item","link":"/api/graphql-api/shop/queries/get-compare-item"}]},{"text":"Mutations","collapsed":false,"items":[{"text":"Create Compare Item","link":"/api/graphql-api/shop/mutations/create-compare-item"},{"text":"Delete Compare Item","link":"/api/graphql-api/shop/mutations/delete-compare-item"},{"text":"Delete All Compare Items","link":"/api/graphql-api/shop/mutations/delete-all-compare-items"}]}]},{"text":"Contact Us","collapsed":true,"items":[{"text":"Mutations","collapsed":false,"items":[{"text":"Create Contact Us","link":"/api/graphql-api/shop/mutations/create-contact-us"}]}]}]},{"text":"Admin API","collapsed":false,"items":[{"text":"Coming Soon","link":"/api/graphql-api/admin-coming-soon"}]},{"text":"Playground Guide","link":"/api/graphql-api/playground"},{"text":"Best Practices","link":"/api/graphql-api/best-practices"},{"text":"Integration Guides","link":"/api/graphql-api/integrations"}]},{"text":"Rest API","collapsed":true,"items":[{"text":"Introduction","link":"/api/rest-api/introduction"},{"text":"Shop API","collapsed":false,"items":[{"text":"Locales","collapsed":false,"items":[{"text":"Get All Locales","link":"/api/rest-api/shop/locales/get-locales"},{"text":"Get Single Locale","link":"/api/rest-api/shop/locales/get-single-locale"}]},{"text":"Categories","collapsed":false,"items":[{"text":"Get Categories","link":"/api/rest-api/shop/categories/get-categories"},{"text":"Get Category","link":"/api/rest-api/shop/categories/get-category"}]},{"text":"Theme Customizations","collapsed":false,"items":[{"text":"Get Theme Customizations","link":"/api/rest-api/shop/theme-customizations/get-theme-customizations"},{"text":"Get Theme Customization","link":"/api/rest-api/shop/theme-customizations/get-theme-customization"}]},{"text":"Products","collapsed":false,"items":[{"text":"Get Products","link":"/api/rest-api/shop/products/get-products"},{"text":"Get Product","link":"/api/rest-api/shop/products/get-product"},{"text":"Search Product","link":"/api/rest-api/shop/products/search-product"}]},{"text":"Product Review","collapsed":false,"items":[{"text":"Get Product Reviews","link":"/api/rest-api/shop/product-reviews/get-product-reviews"},{"text":"Get Product Review","link":"/api/rest-api/shop/product-reviews/get-product-review"},{"text":"Create Product Review","link":"/api/rest-api/shop/product-reviews/create-product-review"},{"text":"Update Product Review","link":"/api/rest-api/shop/product-reviews/update-product-review"},{"text":"Delete Product Review","link":"/api/rest-api/shop/product-reviews/delete-product-review"}]},{"text":"Attribute","collapsed":false,"items":[{"text":"Get Attributes","link":"/api/rest-api/shop/attributes/get-attributes"},{"text":"Single Attribute","link":"/api/rest-api/shop/attributes/get-attribute"},{"text":"Get Attribute Options","link":"/api/rest-api/shop/attributes/get-attribute-options"}]},{"text":"Channel","collapsed":false,"items":[{"text":"Get Channels","link":"/api/rest-api/shop/channels/get-channels"},{"text":"Single Channel","link":"/api/rest-api/shop/channels/get-channel"}]},{"text":"Country and State","collapsed":false,"items":[{"text":"Get Countries","link":"/api/rest-api/shop/countries/get-countries"},{"text":"Single Country","link":"/api/rest-api/shop/countries/get-country"},{"text":"Get Country States","link":"/api/rest-api/shop/countries/get-country-states"},{"text":"Single Country State","link":"/api/rest-api/shop/countries/get-country-state"}]},{"text":"Customer","collapsed":false,"items":[{"text":"Registration","link":"/api/rest-api/shop/customers/customer-registration"},{"text":"Login","link":"/api/rest-api/shop/customers/customer-login"},{"text":"Verify Token","link":"/api/rest-api/shop/customers/customer-verify-token"},{"text":"Customer Logout","link":"/api/rest-api/shop/customers/customer-logout"},{"text":"Forgot Password","link":"/api/rest-api/shop/customers/forgot-password"},{"text":"Reset Password","link":"/api/rest-api/shop/customers/reset-password"},{"text":"Get Addresses","link":"/api/rest-api/shop/customers/get-customer-addresses"},{"text":"Create Address","link":"/api/rest-api/shop/customers/create-customer-address"},{"text":"Update Address","link":"/api/rest-api/shop/customers/update-customer-address"},{"text":"Delete Address","link":"/api/rest-api/shop/customers/delete-customer-address"},{"text":"Get Profile","link":"/api/rest-api/shop/customers/get-customer-profile"},{"text":"Update Profile","link":"/api/rest-api/shop/customers/update-customer-profile"},{"text":"Delete Profile","link":"/api/rest-api/shop/customers/delete-customer-profile"},{"text":"Get Orders","link":"/api/rest-api/shop/customer-orders/get-customer-orders"},{"text":"Get Order","link":"/api/rest-api/shop/customer-orders/get-customer-order"},{"text":"Get Invoices","link":"/api/rest-api/shop/customer-invoices/get-customer-invoices"},{"text":"Get Invoice","link":"/api/rest-api/shop/customer-invoices/get-customer-invoice"},{"text":"Download Invoice PDF","link":"/api/rest-api/shop/customer-invoices/download-customer-invoice-pdf"},{"text":"Get Downloadable Products","link":"/api/rest-api/shop/customer-downloadable-products/get-customer-downloadable-products"},{"text":"Get Downloadable Product","link":"/api/rest-api/shop/customer-downloadable-products/get-customer-downloadable-product"},{"text":"Get Customer Reviews","link":"/api/rest-api/shop/customer-reviews/get-customer-reviews"},{"text":"Get Customer Review","link":"/api/rest-api/shop/customer-reviews/get-customer-review"}]},{"text":"Cart","collapsed":false,"items":[{"text":"Get Cart","link":"/api/rest-api/shop/cart/get-cart"},{"text":"Create Cart","link":"/api/rest-api/shop/cart/create-cart"},{"text":"Add to Cart","link":"/api/rest-api/shop/cart/add-to-cart"},{"text":"Update Cart Item","link":"/api/rest-api/shop/cart/update-cart-item"},{"text":"Remove Cart Item","link":"/api/rest-api/shop/cart/remove-cart-item"},{"text":"Apply Coupon","link":"/api/rest-api/shop/cart/apply-coupon"},{"text":"Remove Coupon","link":"/api/rest-api/shop/cart/remove-coupon"}]},{"text":"Checkout","collapsed":false,"items":[{"text":"Get Addresses","link":"/api/rest-api/shop/checkout/get-addresses"},{"text":"Get Shipping Methods","link":"/api/rest-api/shop/checkout/get-shipping-methods"},{"text":"Get Payment Methods","link":"/api/rest-api/shop/checkout/get-payment-methods"},{"text":"Set Shipping Address","link":"/api/rest-api/shop/checkout/set-shipping-address"},{"text":"Set Billing Address","link":"/api/rest-api/shop/checkout/set-billing-address"},{"text":"Set Shipping Method","link":"/api/rest-api/shop/checkout/set-shipping-method"},{"text":"Set Payment Method","link":"/api/rest-api/shop/checkout/set-payment-method"},{"text":"Place Order","link":"/api/rest-api/shop/checkout/place-order"}]}]},{"text":"Admin API","collapsed":false,"items":[{"text":"Coming Soon","link":"/api/rest-api/admin-coming-soon"}]},{"text":"Testing & Debugging","link":"/api/rest-api/testing-debugging"},{"text":"Best Practices","link":"/api/rest-api/best-practices"}]}]}],"outline":{"level":"deep"},"footer":{"message":"Released under the <a href=\\"https://opensource.org/licenses/mit\\" target=\\"_blank\\" class=\\"mit-license\\">MIT License</a>.","copyright":"Copyright © 2026 Webkul"},"socialLinks":[{"icon":"github","link":"https://github.com/bagisto/bagisto-api"}],"search":{"provider":"local"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CFNU6FAz.js"));
    ...
    initGoogleTranslate() {
      if (!window.googleTranslateElementInit) {
        window.googleTranslateElementInit = () => {
          var _a, _b;
          if ((_b = (_a = window.google) == null ? void 0 : _a.translate) == null ? void 0 : _b.TranslateElement) {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "google-translate-container" }, _attrs))} data-v-38c27986><div id="google_translate_element" data-v-38c27986></div></div>`);
}
...
const GoogleTranslate = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-38c27986"]]);
const REST_API_URL = "https://api-demo.bagisto.com";
const GRAPHQL_API_URL = "https://api-demo.bagisto.com";
function normalizeRestUrl(code) {
  if (!code) return code;
  return code.replace(/http:\/\/127\.0\.0\.1:8001/g, REST_API_URL).replace(/http:\/\/localhost:8001/g, REST_API_URL).replace(/https:\/\/your-domain\.com/g, REST_API_URL).replace(/https:\/\/api\.example\.com/g, REST_API_URL);
}
function normalizeGraphQLUrl(code) {
  if (!code) return code;
  return code.replace(/http:\/\/127\.0\.0\.1:8000/g, GRAPHQL_API_URL).replace(/http:\/\/localhost:8000/g, GRAPHQL_API_URL).replace(/https:\/\/your-domain\.com/g, GRAPHQL_API_URL).replace(/https:\/\/graphql\.example\.com/g, GRAPHQL_API_URL);
}
function normalizeStorageUrl(code, apiUrl = REST_API_URL) {
  if (!code || !apiUrl) return code;
  const baseDomain = apiUrl.replace(/\/api.*$/, "");
  return code.replace(/http:\/\/127\.0\.0\.1:8000\/storage/g, `${baseDomain}/storage`).replace(/http:\/\/localhost:8000\/storage/g, `${baseDomain}/storage`).replace(/https:\/\/your-domain\.com\/storage/g, `${baseDomain}/storage`);
}
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "GraphQLExamplesPanel",
  __ssrInlineRender: true,
  props: {
    examples: { default: () => [] }
  },
...
?>`;
    ...
    const highlightCode = (code, lang) => {
      ...
      if (lang === "graphql") {
        return escaped.replace(/\b(query|mutation|subscription|fragment|on|schema)\b/g, '<span class="keyword">$1</span>').replace(/\b(String|Int|Float|Boolean|ID)\b/g, '<span class="type">$1</span>');
      }
      if (lang === "json") {
        return escaped.replace(/"([^"]*)":/g, '<span class="key">"$1"</span>:').replace(/:\s*(true|false|null)/g, ': <span class="value">$1</span>').replace(/:\s*(\d+(?:\.\d+)?)/g, ': <span class="number">$1</span>').replace(/"([^"]*)"/g, '<span class="string">"$1"</span>');
      }
      return escaped;
    };
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "examples-sidebar" }, _attrs))} data-v-ddfbc9b0><div class="examples-container" data-v-ddfbc9b0><div class="examples-header" data-v-ddfbc9b0><h3 data-v-ddfbc9b0>Examples</h3></div><div class="example-selector" data-v-ddfbc9b0><label for="example-select" data-v-ddfbc9b0>Select Example:</label><select id="example-select" class="example-dropdown" data-v-ddfbc9b0><!--[-->`);
      ssrRenderList(_ctx.examples, (example) => {
        _push(`<option${ssrRenderAttr("value", example.id)} data-v-ddfbc9b0${ssrIncludeBooleanAttr(Array.isArray(selectedExampleId.value) ? ssrLooseContain(selectedExampleId.value, example.id) : ssrLooseEqual(selectedExampleId.value, example.id)) ? " selected" : ""}>${ssrInterpolate(example.title)}</option>`);
      });
      _push(`<!--]--></select></div>`);
      if (selectedExample.value) {
        _push(`<div class="example-content" data-v-ddfbc9b0><h4 data-v-ddfbc9b0>${ssrInterpolate(selectedExample.value.title)}</h4>`);
        if (selectedExample.value.description) {
          _push(`<p class="example-description" data-v-ddfbc9b0>${ssrInterpolate(selectedExample.value.description)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="language-tabs" data-v-ddfbc9b0><div class="language-tabs-header" data-v-ddfbc9b0><!--[-->`);
        ssrRenderList(languageTabs, (tab) => {
          _push(`<button class="${ssrRenderClass(["language-tab-btn", { active: activeLanguageTab.value === tab.id }])}" data-v-ddfbc9b0>${ssrInterpolate(tab.label)}</button>`);
        });
        _push(`<!--]--></div><div class="language-tab-content" data-v-ddfbc9b0><div class="code-block" data-v-ddfbc9b0><div class="btn-group" data-v-ddfbc9b0><button class="${ssrRenderClass([{ copied: copiedButton.value === "query" }, "btn-copy-section"])}"${ssrRenderAttr("title", copiedButton.value === "query" ? "Copied!" : "Copy code")} data-v-ddfbc9b0><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-ddfbc9b0><path d="M4 1.5H10C10.8284 1.5 11.5 2.1716 11.5 3V9C11.5 9.8284 10.8284 10.5 10 10.5H4C3.1716 10.5 2.5 9.8284 2.5 9V3C2.5 2.1716 3.1716 1.5 4 1.5Z" fill="none" stroke="currentColor" stroke-width="1" data-v-ddfbc9b0></path><path d="M6 5.5H12C12.8284 5.5 13.5 6.1716 13.5 7V13C13.5 13.8284 12.8284 14.5 12 14.5H6C5.1716 14.5 4.5 13.8284 4.5 13V7C4.5 6.1716 5.1716 5.5 6 5.5Z" fill="currentColor" stroke="none" data-v-ddfbc9b0></path></svg></button><button class="btn-play-section" title="Run in GraphiQL" data-v-ddfbc9b0><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-ddfbc9b0><path d="M3.5 2C3.22386 2 3 2.22386 3 2.5V13.5C3 13.7761 3.22386 14 3.5 14C3.77614 14 4 13.7761 4 13.5V2.5C4 2.22386 3.77614 2 3.5 2Z" fill="currentColor" data-v-ddfbc9b0></path><path d="M13.5 8L5 12.5L5 3.5L13.5 8Z" fill="currentColor" data-v-ddfbc9b0></path></svg></button><button class="btn-info-section" title="Documentation" data-v-ddfbc9b0><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-ddfbc9b0><path d="M8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1ZM8 2.5C10.9375 2.5 13.5 5.0625 13.5 8C13.5 10.9375 10.9375 13.5 8 13.5C5.0625 13.5 2.5 10.9375 2.5 8C2.5 5.0625 5.0625 2.5 8 2.5ZM8 4C7.58579 4 7.25 4.33579 7.25 4.75V8C7.25 8.41421 7.58579 8.75 8 8.75C8.41421 8.75 8.75 8.41421 8.75 8V4.75C8.75 4.33579 8.41421 4 8 4ZM8 10C7.72386 10 7.5 10.2239 7.5 10.5C7.5 10.7761 7.72386 11 8 11C8.27614 11 8.5 10.7761 8.5 10.5C8.5 10.2239 8.27614 10 8 11Z" fill="currentColor" data-v-ddfbc9b0></path></svg></button></div><pre data-v-ddfbc9b0><code data-v-ddfbc9b0>${getLanguageCode() ?? ""}</code></pre></div></div></div>`);
        if ((_a = selectedExample.value) == null ? void 0 : _a.variables) {
          _push(`<div class="section-variables" data-v-ddfbc9b0><h5 data-v-ddfbc9b0>Variables</h5><div class="code-block" data-v-ddfbc9b0><div class="btn-group" data-v-ddfbc9b0><button class="${ssrRenderClass([{ copied: copiedButton.value === "variables" }, "btn-copy-section"])}"${ssrRenderAttr("title", copiedButton.value === "variables" ? "Copied!" : "Copy variables")} data-v-ddfbc9b0><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-ddfbc9b0><path d="M4 1.5H10C10.8284 1.5 11.5 2.1716 11.5 3V9C11.5 9.8284 10.8284 10.5 10 10.5H4C3.1716 10.5 2.5 9.8284 2.5 9V3C2.5 2.1716 3.1716 1.5 4 1.5Z" fill="none" stroke="currentColor" stroke-width="1" data-v-ddfbc9b0></path><path d="M6 5.5H12C12.8284 5.5 13.5 6.1716 13.5 7V13C13.5 13.8284 12.8284 14.5 12 14.5H6C5.1716 14.5 4.5 13.8284 4.5 13V7C4.5 6.1716 5.1716 5.5 6 5.5Z" fill="currentColor" stroke="none" data-v-ddfbc9b0></path></svg></button></div><pre data-v-ddfbc9b0><code data-v-ddfbc9b0>${highlightCode(selectedExample.value.variables, "json") ?? ""}</code></pre></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="section-response" data-v-ddfbc9b0><h5 data-v-ddfbc9b0>Response</h5><div class="code-block" data-v-ddfbc9b0><div class="btn-group" data-v-ddfbc9b0><button class="${ssrRenderClass([{ copied: copiedButton.value === "response" }, "btn-copy-section"])}"${ssrRenderAttr("title", copiedButton.value === "response" ? "Copied!" : "Copy response")} data-v-ddfbc9b0><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-ddfbc9b0><path d="M4 1.5H10C10.8284 1.5 11.5 2.1716 11.5 3V9C11.5 9.8284 10.8284 10.5 10 10.5H4C3.1716 10.5 2.5 9.8284 2.5 9V3C2.5 2.1716 3.1716 1.5 4 1.5Z" fill="none" stroke="currentColor" stroke-width="1" data-v-ddfbc9b0></path><path d="M6 5.5H12C12.8284 5.5 13.5 6.1716 13.5 7V13C13.5 13.8284 12.8284 14.5 12 14.5H6C5.1716 14.5 4.5 13.8284 4.5 13V7C4.5 6.1716 5.1716 5.5 6 5.5Z" fill="currentColor" stroke="none" data-v-ddfbc9b0></path></svg></button></div><pre data-v-ddfbc9b0><code data-v-ddfbc9b0>${highlightCode(selectedExample.value.response, "json") ?? ""}</code></pre></div></div>`);
        if (selectedExample.value.commonErrors && selectedExample.value.commonErrors.length > 0) {
          _push(`<div class="section-errors" data-v-ddfbc9b0><h5 data-v-ddfbc9b0>Common Errors</h5><div class="errors-list" data-v-ddfbc9b0><!--[-->`);
          ssrRenderList(selectedExample.value.commonErrors, (error) => {
            _push(`<div class="error-item" data-v-ddfbc9b0><div class="error-code" data-v-ddfbc9b0><strong data-v-ddfbc9b0>${ssrInterpolate(error.error)}</strong></div><div class="error-details" data-v-ddfbc9b0><p data-v-ddfbc9b0><strong data-v-ddfbc9b0>Cause:</strong> ${ssrInterpolate(error.cause)}</p><p data-v-ddfbc9b0><strong data-v-ddfbc9b0>Solution:</strong> ${ssrInterpolate(error.solution)}</p></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/components/GraphQLExamplesPanel.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const GraphQLExamplesPanel = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ddfbc9b0"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "RestExamplesPanel",
  __ssrInlineRender: true,
  props: {
    examples: { default: () => [] }
  },
  setup(__props) {
    ...
    const generateNodeCode = () => {
      var _a, _b;
      const curl = ((_a = selectedExample.value) == null ? void 0 : _a.curl) || ((_b = selectedExample.value) == null ? void 0 : _b.request) || "";
      if (!curl) return "";
...
`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<aside${ssrRenderAttrs(mergeProps({ class: "examples-sidebar" }, _attrs))} data-v-3532605d><div class="examples-container" data-v-3532605d><div class="examples-header" data-v-3532605d><h3 data-v-3532605d>Examples</h3></div><div class="example-selector" data-v-3532605d><label for="example-select" data-v-3532605d>Select Example:</label><select id="example-select" class="example-dropdown" data-v-3532605d><!--[-->`);
      ssrRenderList(_ctx.examples, (example) => {
        _push(`<option${ssrRenderAttr("value", example.id)} data-v-3532605d${ssrIncludeBooleanAttr(Array.isArray(selectedExampleId.value) ? ssrLooseContain(selectedExampleId.value, example.id) : ssrLooseEqual(selectedExampleId.value, example.id)) ? " selected" : ""}>${ssrInterpolate(example.title)}</option>`);
      });
      _push(`<!--]--></select></div>`);
      if (selectedExample.value) {
        _push(`<div class="example-content" data-v-3532605d><h4 data-v-3532605d>${ssrInterpolate(selectedExample.value.title)}</h4>`);
        if (selectedExample.value.description) {
          _push(`<p class="example-description" data-v-3532605d>${ssrInterpolate(selectedExample.value.description)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="language-tabs" data-v-3532605d><div class="language-tabs-header" data-v-3532605d><!--[-->`);
        ssrRenderList(languageTabs, (tab) => {
          _push(`<button class="${ssrRenderClass(["language-tab-btn", { active: activeLanguageTab.value === tab.id }])}" data-v-3532605d>${ssrInterpolate(tab.label)}</button>`);
        });
        _push(`<!--]--></div><div class="language-tab-content" data-v-3532605d><div class="code-block" data-v-3532605d><div class="btn-group" data-v-3532605d><button class="${ssrRenderClass([{ copied: copiedButton.value === "request" }, "btn-copy-section"])}"${ssrRenderAttr("title", copiedButton.value === "request" ? "Copied!" : "Copy code")} data-v-3532605d><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-3532605d><path d="M4 1.5H10C10.8284 1.5 11.5 2.1716 11.5 3V9C11.5 9.8284 10.8284 10.5 10 10.5H4C3.1716 10.5 2.5 9.8284 2.5 9V3C2.5 2.1716 3.1716 1.5 4 1.5Z" fill="none" stroke="currentColor" stroke-width="1" data-v-3532605d></path><path d="M6 5.5H12C12.8284 5.5 13.5 6.1716 13.5 7V13C13.5 13.8284 12.8284 14.5 12 14.5H6C5.1716 14.5 4.5 13.8284 4.5 13V7C4.5 6.1716 5.1716 5.5 6 5.5Z" fill="currentColor" stroke="none" data-v-3532605d></path></svg></button></div><pre data-v-3532605d><code data-v-3532605d>${getLanguageCode() ?? ""}</code></pre></div></div></div>`);
        if ((_a = selectedExample.value) == null ? void 0 : _a.headers) {
          _push(`<div class="section-headers" data-v-3532605d><h5 data-v-3532605d>Headers</h5><div class="code-block" data-v-3532605d><div class="btn-group" data-v-3532605d><button class="${ssrRenderClass([{ copied: copiedButton.value === "headers" }, "btn-copy-section"])}"${ssrRenderAttr("title", copiedButton.value === "headers" ? "Copied!" : "Copy headers")} data-v-3532605d><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-3532605d><path d="M4 1.5H10C10.8284 1.5 11.5 2.1716 11.5 3V9C11.5 9.8284 10.8284 10.5 10 10.5H4C3.1716 10.5 2.5 9.8284 2.5 9V3C2.5 2.1716 3.1716 1.5 4 1.5Z" fill="none" stroke="currentColor" stroke-width="1" data-v-3532605d></path><path d="M6 5.5H12C12.8284 5.5 13.5 6.1716 13.5 7V13C13.5 13.8284 12.8284 14.5 12 14.5H6C5.1716 14.5 4.5 13.8284 4.5 13V7C4.5 6.1716 5.1716 5.5 6 5.5Z" fill="currentColor" stroke="none" data-v-3532605d></path></svg></button></div><pre data-v-3532605d><code data-v-3532605d>${highlightCode(selectedExample.value.headers, "json") ?? ""}</code></pre></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="section-response" data-v-3532605d><h5 data-v-3532605d>Response</h5><div class="code-block" data-v-3532605d><div class="btn-group" data-v-3532605d><button class="${ssrRenderClass([{ copied: copiedButton.value === "response" }, "btn-copy-section"])}"${ssrRenderAttr("title", copiedButton.value === "response" ? "Copied!" : "Copy response")} data-v-3532605d><svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" data-v-3532605d><path d="M4 1.5H10C10.8284 1.5 11.5 2.1716 11.5 3V9C11.5 9.8284 10.8284 10.5 10 10.5H4C3.1716 10.5 2.5 9.8284 2.5 9V3C2.5 2.1716 3.1716 1.5 4 1.5Z" fill="none" stroke="currentColor" stroke-width="1" data-v-3532605d></path><path d="M6 5.5H12C12.8284 5.5 13.5 6.1716 13.5 7V13C13.5 13.8284 12.8284 14.5 12 14.5H6C5.1716 14.5 4.5 13.8284 4.5 13V7C4.5 6.1716 5.1716 5.5 6 5.5Z" fill="currentColor" stroke="none" data-v-3532605d></path></svg></button></div><pre data-v-3532605d><code data-v-3532605d>${highlightCode(selectedExample.value.response, "json") ?? ""}</code></pre></div></div>`);
        if (selectedExample.value.commonErrors && selectedExample.value.commonErrors.length > 0) {
          _push(`<div class="section-errors" data-v-3532605d><h5 data-v-3532605d>Common Errors</h5><div class="errors-list" data-v-3532605d><!--[-->`);
          ssrRenderList(selectedExample.value.commonErrors, (error) => {
            _push(`<div class="error-item" data-v-3532605d><div class="error-code" data-v-3532605d><strong data-v-3532605d>${ssrInterpolate(error.error)}</strong></div><div class="error-details" data-v-3532605d><p data-v-3532605d><strong data-v-3532605d>Cause:</strong> ${ssrInterpolate(error.cause)}</p><p data-v-3532605d><strong data-v-3532605d>Solution:</strong> ${ssrInterpolate(error.solution)}</p></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../.vitepress/theme/components/RestExamplesPanel.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const RestExamplesPanel = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-3532605d"]]);
const _sfc_main = {
  __name: "Layout",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    function loadExamples() {
      nextTick(() => {
        var _a, _b;
        if ((_b = (_a = route.data) == null ? void 0 : _a.frontmatter) == null ? void 0 : _b.examples) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Layout2), _attrs, {
        "nav-bar-content-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isClient.value) {
              _push2(ssrRenderComponent(GoogleTranslate, null, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              isClient.value ? (openBlock(), createBlock(GoogleTranslate, { key: 0 })) : createCommentVNode("", true)
            ];
          }
        }),
        "aside-bottom": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isClient.value && pageExamples.value.length && isGraphQL.value) {
              _push2(ssrRenderComponent(GraphQLExamplesPanel, { examples: pageExamples.value }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            if (isClient.value && pageExamples.value.length && !isGraphQL.value) {
              _push2(ssrRenderComponent(RestExamplesPanel, { examples: pageExamples.value }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              isClient.value && pageExamples.value.length && isGraphQL.value ? (openBlock(), createBlock(GraphQLExamplesPanel, {
                key: 0,
                examples: pageExamples.value
              }, null, 8, ["examples"])) : createCommentVNode("", true),
              isClient.value && pageExamples.value.length && !isGraphQL.value ? (openBlock(), createBlock(RestExamplesPanel, {
                key: 1,
                examples: pageExamples.value
              }, null, 8, ["examples"])) : createCommentVNode("", true)
            ];
...
function setupAllTabs() {
  ...
  tabContainers.forEach((container) => {
    const alreadyInit = container._tabsInitialized;
    if (!alreadyInit) {
...
function setupTabContainer(container) {
  const tabButtons = Array.from(container.querySelectorAll(".code-tab"));
  ...
  const graphiqlBtn = container.querySelector(".btn-graphiql");
  const descriptionBtn = container.querySelector(".btn-description");
...
function copyActiveCode(container) {
...
function copyUsingFallback(code, button) {
  try {
...
function openGraphiQL(container) {
  const activeContent = container.querySelector(".tab-content.active");
...
if (typeof window !== "undefined") {
  window.__switchTab = function(button, index) {
